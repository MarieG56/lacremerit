      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <Formik
          ...
          onSubmit={async (values, { setSubmitting, setStatus }) => {
            setStatus(null);
            try {
              // Update the order with new status, client/customer and total amount
              ...
              // Update each existing order item
              ...
              setStatus("Erreur lors de la modification de la commande.");
            } finally {
              setSubmitting(false);
            }
          }}
                ...
                {({ push, remove }) => (
                  <div>
                    ...
                    {values.orderItems.map((item, index) => {
                      // Get current search value for product filtering
